...
for(const x of p){if(unitree[x.id]){x.officialUrl=unitree[x.id];x.hasAmazon=false;x.amazonLinkType="official";x.commerceRoute="Unitree Official Store";}if(x.id===6){x.officialUrl="https://www.amazon.com/dp/B0DFHNGDGM?tag=gearguruguide-20";x.hasAmazon=true;x.amazonLinkType="product";x.commerceRoute="Amazon Associates";}}
