...
const verifiedAmazon={72:"B08BCTC22X",228:"B01N5O7551",409:"B06Y3TC113",636:"B0D7PPG25F",650:"B0CLGZB3L6",491:"B0FN7MSY4L",74:"B0DG3JT4H6",622:"B0DCC2BVFW",23:"B0C6DHK68Q",468:"B0F42HLLSC",646:"B07HFHTGX3",380:"B07V6CWS26",9234:"B0C7VP2CXP"};
...
for(const x of p){if(verifiedAmazon[x.id]){x.officialUrl="https://www.amazon.com/dp/"+verifiedAmazon[x.id]+"?tag=gearguruguide-20";x.hasAmazon=true;x.amazonLinkType="product";x.commerceRoute="Amazon Associates";}if(unitree[x.id]){x.officialUrl=unitree[x.id];x.hasAmazon=false;x.amazonLinkType="official";x.commerceRoute="Unitree Official Store";}if(x.id===6){x.officialUrl="https://www.garmin.com/en-US/p/1191310/pn/010-02887-00/";x.hasAmazon=false;x.amazonLinkType="official";x.commerceRoute="Garmin Official Product";}}
